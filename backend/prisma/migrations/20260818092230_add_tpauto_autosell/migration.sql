...
INSERT INTO "new_MinecraftAccount" ("afkEnabled", "afkIntervalSeconds", "authType", "autoCommandEnabled", "autoCommandIntervalMinutes", "autoCommandText", "autoReconnect", "createdAt", "createdById", "credentialsPassword", "credentialsSecret", "id", "minecraftVersion", "movementEnabled", "name", "serverHost", "serverPort", "status", "updatedAt") SELECT "afkEnabled", "afkIntervalSeconds", "authType", "autoCommandEnabled", "autoCommandIntervalMinutes", "autoCommandText", "autoReconnect", "createdAt", "createdById", "credentialsPassword", "credentialsSecret", "id", "minecraftVersion", "movementEnabled", "name", "serverHost", "serverPort", "status", "updatedAt" FROM "MinecraftAccount";
