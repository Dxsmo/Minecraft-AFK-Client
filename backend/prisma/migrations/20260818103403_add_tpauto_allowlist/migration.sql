...
INSERT INTO "new_MinecraftAccount" ("afkEnabled", "afkIntervalSeconds", "authType", "autoCommandEnabled", "autoCommandIntervalMinutes", "autoCommandText", "autoReconnect", "autoSellCommand", "autoSellEnabled", "autoSellIntervalSeconds", "createdAt", "createdById", "credentialsPassword", "credentialsSecret", "id", "minecraftVersion", "movementEnabled", "name", "serverHost", "serverPort", "status", "tpAutoEnabled", "updatedAt") SELECT "afkEnabled", "afkIntervalSeconds", "authType", "autoCommandEnabled", "autoCommandIntervalMinutes", "autoCommandText", "autoReconnect", "autoSellCommand", "autoSellEnabled", "autoSellIntervalSeconds", "createdAt", "createdById", "credentialsPassword", "credentialsSecret", "id", "minecraftVersion", "movementEnabled", "name", "serverHost", "serverPort", "status", "tpAutoEnabled", "updatedAt" FROM "MinecraftAccount";
