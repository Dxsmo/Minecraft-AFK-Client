...
INSERT INTO "new_SniperAccount" ("cooldownSeconds", "createdAt", "createdById", "currentName", "dashboardOrder", "desiredName", "email", "enabled", "id", "label", "lastAttemptAt", "lastResult", "lastSuccess", "rateLimitProtection", "status", "updatedAt") SELECT "cooldownSeconds", "createdAt", "createdById", "currentName", "dashboardOrder", "desiredName", "email", "enabled", "id", "label", "lastAttemptAt", "lastResult", "lastSuccess", "rateLimitProtection", "status", "updatedAt" FROM "SniperAccount";
