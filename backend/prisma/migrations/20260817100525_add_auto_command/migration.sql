...
INSERT INTO "new_MinecraftAccount" ("afkEnabled", "afkIntervalSeconds", "authType", "autoReconnect", "createdAt", "credentialsSecret", "id", "minecraftVersion", "movementEnabled", "name", "serverHost", "serverPort", "status", "updatedAt") SELECT "afkEnabled", "afkIntervalSeconds", "authType", "autoReconnect", "createdAt", "credentialsSecret", "id", "minecraftVersion", "movementEnabled", "name", "serverHost", "serverPort", "status", "updatedAt" FROM "MinecraftAccount";
